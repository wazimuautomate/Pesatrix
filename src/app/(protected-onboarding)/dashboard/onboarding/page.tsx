...
export default async function DashboardOnboardingPage() {
  ...
  if (statusResult.error) {
    console.error("[DashboardOnboardingPage] Failed to read account_status:", statusResult.error);
  ...
  if (!accountStatus) {
    ...
    if (adminStatusError) {
      console.error("[DashboardOnboardingPage] Failed to read account_status with service role:", adminStatusError);
      throw new Error("Could not load account status");
    }
